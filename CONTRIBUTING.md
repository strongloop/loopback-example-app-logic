...
Thank you for your interest in `loopback-example-app-logic`, an open source project
administered by StrongLoop.

Contributing to `loopback-example-app-logic` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/strongloop/loopback-example-app-logic)
